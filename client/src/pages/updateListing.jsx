...
import { useGetSingleListingQuery, useUpdateListingMutation } from "../store";
...
function UpdateListing() {
  ...
  const [updateListing, result] = useUpdateListingMutation();

  const { data } = useGetSingleListingQuery(params.listingId);
    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          >
            {result.isLoading ? "Updating..." : "Update car list"}
          </button>
        </div>
      </form>
    </main>
